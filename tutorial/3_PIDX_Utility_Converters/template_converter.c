...
int main(int argc, char **argv)
{
  ...
  for (i=0;i<2;i++)
  {
    int tmp=local_box_size[i];
    local_box_size[i]=local_box_size[3-i];
    local_box_size[3-i]=tmp;
    tmp=local_box_offset[i];
    local_box_offset[i]=local_box_offset[3-i];
    local_box_offset[3-i]=tmp;
  }
  printf("(%d) (reversed) offset: %d %d %d %d, size: %d %d %d %d\n",rank,local_box_offset[0],local_box_offset[1],local_box_offset[2],local_box_offset[3],local_box_size[0],local_box_size[1],local_box_size[2],local_box_size[3]);

  //if ((ret = nc_get_var(ncid, varid, *buffer)))
  //if ((ret = nc_get_var1(ncid, varid, local_box_offset, *buffer)))
  if ((ret = nc_get_vara(ncid, varid, local_box_offset, local_box_size, *buffer)))
    handle_error(ret,"",__FILE__,__LINE__);
  ...
  printf("(%d) (re-reversed) offset: %d %d %d %d, size: %d %d %d %d\n",rank,local_box_offset[0],local_box_offset[1],local_box_offset[2],local_box_offset[3],local_box_size[0],local_box_size[1],local_box_size[2],local_box_size[3]);
