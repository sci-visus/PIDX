...
#ifndef __PIDX_GLOBAL_IDX_IO_H
#define __PIDX_GLOBAL_IDX_IO_H


struct PIDX_global_idx_io_descriptor;
typedef struct PIDX_global_idx_io_descriptor* PIDX_global_idx_io;
...
///
//PIDX_return_code PIDX_idx_read(PIDX_global_idx_io file, int start_var_index, int end_var_index);
