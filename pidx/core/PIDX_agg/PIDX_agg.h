...
///
PIDX_return_code PIDX_agg_buf_create_local_uniform_dist(PIDX_agg_id agg_id, Agg_buffer agg_buffer, PIDX_block_layout local_block_layout, int i1, int j1, int file_status);
